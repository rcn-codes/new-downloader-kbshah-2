...
sealed interface DownloadsIntent {
    ...
    data class OnDeleteConfirmed(val item: DownloadedVideo) : DownloadsIntent
    data object OnDeletedDialogDismissed : DownloadsIntent
}
...
data class DownloadsState(
    ...
    val showDeletedSuccess: Boolean = false,
)
